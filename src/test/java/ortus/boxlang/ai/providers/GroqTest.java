 ...
 */
public class GroqTest extends BaseIntegrationTest {

	@BeforeEach
	public void beforeEach() {
		moduleRecord.settings.put( "apiKey", dotenv.get( "GROQ_API_KEY", "" ) );
		moduleRecord.settings.put( "provider", "groq" );
	}

	@DisplayName( "Test Groq AI" )
	@Test
	...
	@DisplayName( "Test streaming chat with Groq" )
	@Test
