...
public class MiniMaxTest extends BaseIntegrationTest {
	...
	public void beforeEach() {
		moduleRecord.settings.put( "apiKey", dotenv.get( "MINIMAX_API_KEY", "" ) );
		moduleRecord.settings.put( "provider", "minimax" );
	}

	@DisplayName( "Test MiniMax AI chat" )
	@Test
	...
	@DisplayName( "Test streaming chat with MiniMax" )
	@Test
