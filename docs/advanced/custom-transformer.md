---
description: "Learn how to build custom transformers to process and shape data in BoxLang AI pipelines."
...
- 📖 **Pipeline Patterns**: [Building pipelines](../main-components/overview.md)
