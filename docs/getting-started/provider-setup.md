---
description: "Comprehensive guide to configuring AI providers in BoxLang AI - from API keys to local deployment with Ollama."
icon: puzzle-piece
---
...
See [Running Ollama with Docker](installation.md#running-ollama-with-docker) in the installation guide.
...
- **[Installation Guide](installation.md)** - Install the BoxLang AI module
- **[Quick Start](quickstart.md)** - Your first AI conversation
- **[Basic Chatting](../chatting/basic-chatting.md)** - Learn the fundamentals
- **[Advanced Features](../chatting/advanced-chatting.md)** - Tools, streaming, multimodal
