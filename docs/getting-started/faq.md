---
description: "Frequently asked questions about BoxLang AI - answers to common questions about costs, providers, performance, and usage."
icon: circle-question
---

# ❓ Frequently Asked Questions

Quick answers to the most common questions about BoxLang AI. If you don't find your answer here, check the [main documentation](../README.md) or ask in the [community forum](https://community.boxlang.io).
...
**Guide**: [Installation - Ollama Setup](installation.md#ollama-local-ai)
...
**Full comparison**: [Provider Setup Guide](provider-setup.md)
...
**More tips**: [Advanced Topics - Performance](../advanced/performance.md) *(coming soon)*
...
**Guide**: [Production Deployment](../advanced/production.md) *(coming soon)*
...
**Full guide**: [Structured Output](../chatting/structured-output.md)
...
**Full guide**: [Memory Systems](../main-components/memory.md)
...
**Full guide**: [RAG (Retrieval Augmented Generation)](../main-components/rag.md)
...
**Full guide**: [Advanced Chatting - Multimodal](../chatting/advanced-chatting.md)
...
**Full guide**: [Multi-Tenant Memory](../advanced/multi-tenant-memory.md)
...
**Full guide**: [Security & Best Practices](../advanced/security.md) *(coming soon)*
...
**Full guide**: [Provider Setup - API Keys](provider-setup.md)
